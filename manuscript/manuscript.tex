...
\eds{Is $T_n^*$ the same as $T_n^{(b)}$?}  
\eds{Can we replace the $t$ index with $i$ 
...
\eds{I think this is fine -- $t$ or $i$ would have worked, as long as it is 
consistently used within the time series sections.}
