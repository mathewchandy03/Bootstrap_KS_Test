...
necessary, as the p-values are not aligned with the line in the Q-Q plots. This
...
rate \jy{Does not sound right. What is $\alpha$?}
...
\jy{alpha has been used as gamma parameters. This is not necessary, Just say we
  checked the power when the significance level is .05.}
