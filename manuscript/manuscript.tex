...
clarify which $T_n$ you are referring to here.} 
...
time-series data? ($t$ is used in the Simulation section below.)}
...
\eds{Leaving it like this is fine, thanks!}
    }
\label{table:size}
...
Additionally, we constructed 95\% confidence intervals of the actual rejection rate.
\eds{what do you mean by `actual' rejection rate? True rejection rate?  
I don't see the CI in Figure 2.}
