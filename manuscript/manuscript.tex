...
\citep{zeimbakakis2024misuses} would necessitate defining a
...
\jy{Watch proper usage of dashes.}
Still, even for settings where the block sizes are usually less than $\sqrt{n}$ -
...
of the selected block sizes for this setting.
...
\jy{too strong. soften it.}
recommend the original cubic root setting over that introduced by 
