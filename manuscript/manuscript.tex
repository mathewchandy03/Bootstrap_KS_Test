...
In this simulation study, we aim to show that the test correctly fails to 
reject $H_0$ under the null
distribution, and correctly rejects $H_0$ for an alternate distribution. If
...
to see if a serially dependenttime series follows a hypothesized distribution and the parameters
...
different dependence structures. One could also apply the method showcased
