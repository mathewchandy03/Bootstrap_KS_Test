...
From Table~\ref{table:rr_100}, we can see that when $n = 100$, the rejection 
rate may 
be quite low, especially for lower values of $\alpha$. From 
...
As shown in Tables~\ref{table:rr_800}, \ref{table:rr_1600}, and 
