...
\presentaddress{21 Maxfelix Dr, Storrs, CT 06268}

%\fundingInfo{Text}
%\JELinfo{ejlje}

\abstract[Abstract]{The Kolmogorov--Smirnov (KS) test is a widely used statistical test that
...
The data utilized in this study were obtained using the 
\textsl{tseries} package \citep{tseries}. The data provider is Yahoo.
