...
replaced by the bootstrap samples $\{X_i: i = 1, \ldots, n\}^{(b)}=\{X_1^{(b)},\dots,X_n^{(b)}\}$.
...
\subsection{Finite-Dimensional Convergence in the Bootstrap World}
...
\subsection{Tightness in Bootstrap World}
